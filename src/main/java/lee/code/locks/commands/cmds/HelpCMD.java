...
public class HelpCMD extends SubCommand {
  ...
  public void performSender(CommandSender sender, String[] args) {
    ...
    for (SubCommand subCommand : locks.getCommandManager().getSubCommandList()) commands.put(subCommand, subCommand.getName());
